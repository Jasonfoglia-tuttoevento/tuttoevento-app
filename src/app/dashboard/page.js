  ...
  function renderTab() {
    ...
    if (role === "artist") {
      ...
      switch(activeTab) {
        ...
        case "video":     return <ArtistArea currentUser={user} tab="video"     {...p} {...Object.fromEntries(Object.keys(p).map(k=>[`set${k.charAt(0).toUpperCase()+k.slice(1)}`, setP(k)]))} saveArtistProfile={saveArtistProfile} artistMessage={artistMessage} bookings={bookings} />;
