...
import { SCard, STitle, ProBadge, ProLock, KpiCard, O, INK, MUTED } from "./shared";
...
interface ArtistAnaliticheProps {
  bookings?: Booking[];
  plan?: string;
}

export default function ArtistAnalitiche({ bookings = [], plan }: ArtistAnaliticheProps) {
