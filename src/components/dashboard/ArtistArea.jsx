  ...
  return (
    <div className="te-area w-full max-w-full overflow-hidden space-y-6 sm:space-y-8">
      <style>{`
        ...
        .te-area .te-compact-input {
          min-height: 54px;
        }

        .te-area .te-scroll-thin {
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
              ...
              <Field label="Disponibilità / note booking">
                <textarea
                  placeholder="Preferenze, limitazioni o note utili per le richieste booking."
                  value={availability}
              ...
              <Field label="Service">
                <textarea
                  placeholder="Impianto audio, luci, backline, hospitality o altre esigenze."
                  value={rider}
                  ...
                  <Field label="Compensi indicativi">
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                      {eventTypes.map((eventTypeId) => (
                        ...
                        >
                          <p className="font-extrabold mb-3 text-sm">
                ...
                <div className="space-y-3 max-h-[340px] overflow-y-auto pr-1 te-scroll-thin">
                  ...
                  {bookedSlots.length > 8 && (
                    <p className="text-sm text-black/40 font-bold">
                      + {bookedSlots.length - 8} altri eventi confermati
                    </p>
                  )}
                </div>
              )}
