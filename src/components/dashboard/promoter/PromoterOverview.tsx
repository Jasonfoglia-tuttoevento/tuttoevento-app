...
import { Card, INK, KpiCard, MUTED, O, STitle, StatusBadge, fmt } from "./shared";
...
interface Commission {
  ...
  promoter_share_amount?: number | string;
  status?: string;
  [key: string]: unknown;
}
...
export default function PromoterOverview({ currentUser, bookings = [], portfolio = [], contactRequests = [], plan, commissions = [] }: PromoterOverviewProps) {
