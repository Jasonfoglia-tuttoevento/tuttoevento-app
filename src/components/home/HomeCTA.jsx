...
export default function HomeCTA() {
  return (
    <>
      <style>{`
        .hct-root { background:#0a0a0b; padding:80px 20px; overflow:hidden; }
        ...
        .hct-label { font-size:.75rem; font-weight:700; color:#ff5a00; text-transform:uppercase; letter-spacing:.2em; margin-bottom:16px; position:relative; font-family:'Manrope',sans-serif; }
        ...
        .hct-sub { color:rgba(255,255,255,.55); font-size:1.05rem; max-width:480px; margin:0 auto 40px; line-height:1.7; position:relative; font-family:'Manrope',sans-serif; }
        .hct-ctas { display:flex; gap:14px; justify-content:center; flex-wrap:wrap; position:relative; }
        .hct-primary { background:#ff5a00; color:#fff; font-weight:800; font-size:1.05rem; padding:16px 36px; border-radius:100px; text-decoration:none; transition:all .25s; box-shadow:0 16px 40px rgba(255,90,0,.4); display:inline-flex; align-items:center; gap:8px; font-family:'Manrope',sans-serif; }
        .hct-primary:hover { background:#e85100; transform:translateY(-2px) scale(1.02); }
        .hct-ghost { background:rgba(255,255,255,.06); color:#fff; font-weight:700; font-size:1rem; padding:16px 32px; border-radius:100px; text-decoration:none; border:1px solid rgba(255,255,255,.15); transition:all .25s; font-family:'Manrope',sans-serif; }
        .hct-ghost:hover { background:rgba(255,255,255,.12); }
        .hct-trust { display:flex; gap:20px; justify-content:center; margin-top:32px; flex-wrap:wrap; position:relative; }
        .hct-trust-item { display:flex; align-items:center; gap:6px; color:rgba(255,255,255,.35); font-size:.8rem; font-weight:600; font-family:'Manrope',sans-serif; }
        .hct-trust-item span:first-child { color:#16a34a; }
        @media(max-width:600px) { .hct-box{padding:48px 24px} }
      `}</style>
