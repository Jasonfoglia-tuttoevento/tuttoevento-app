  ...
  return (
    <>
      <style>{`
        ...
        .hn-root.scrolled { background:rgba(10,10,11,.88); backdrop-filter:blur(20px); border-bottom:1px solid rgba(255,255,255,.06); }
        ...
        .hn-logo { font-family:'Sora',sans-serif; font-weight:900; font-size:1.15rem; letter-spacing:-.04em; text-decoration:none; color:#fff; animation:te-logo-glow 3s ease-in-out infinite; }
        ...
        .hn-mobile-close { position:absolute; top:20px; right:20px; background:none; border:none; color:#fff; font-size:2rem; cursor:pointer; font-family:'Sora',sans-serif; }
      `}</style>
      ...
      <div className={`hn-mobile${menuOpen?" open":""}`}>
        ...
        <Link href="/login" style={{ color:"rgba(255,255,255,.6)", fontSize:"1rem", fontFamily:"'Manrope',sans-serif" }} onClick={() => setMenuOpen(false)}>Accedi</Link>
